...
The interface is slightly different than with {\tt lock} statement or {\tt Synchronized} attribute 
...
{\tt Pulse} on any of those individual variables as required.
...
variables.  For example, starting from .NET 4 standard library includes a class
